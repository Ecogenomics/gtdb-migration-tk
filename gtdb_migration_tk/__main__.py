...
def __ftp_genbank_genome_dirs_file(group, required):
    group.add_argument('--new_genbank_directory', dest="ftp_genbank_genome_dirs", required=required,
...
def __ftp_path_file(group, required):
    group.add_argument('--ftp_genome_dir_file', required=required,
...
def __gbk_arc_assembly_file(group, required):
    group.add_argument('--gbk_arc_assembly_file', required=required, help="Archaeal Assembly summary file from Genbank")


def __gbk_bac_assembly_file(group, required):
    group.add_argument('--gbk_bac_assembly_file', required=required,
...
def __new_list_genomes(group, required):
    group.add_argument('--new_list_genomes', required=required,
...
def __rfq_arc_assembly_file(group, required):
    group.add_argument('--rfq_arc_assembly_file', required=required, help="Archaeal Assembly summary file from Refseq")


def __rfq_bac_assembly_file(group, required):
    group.add_argument('--rfq_bac_assembly_file', required=required, help="Bacterial Assembly summary file from Refseq")
...
def __taxonomy_file(group, required):
    group.add_argument('--taxonomy_file', required=required,
